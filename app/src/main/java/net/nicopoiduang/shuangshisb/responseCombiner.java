...
public class responseCombiner {
    private String HTTPHeader,nameBox,loginButton,updateButton,combineTeamButton,agreeButton,disagreeButton, assassinateButton,adminButton;
    player player;
    game game;
    ...
    private String getScoreTable()
    {
        ...
        for (int i=0;i<=4;i++)
        {
            ...
            else result.append(game.teamSize[game.getPlayerCount()][i]+"人");
            result.append("</td>");
        }
